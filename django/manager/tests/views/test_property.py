...
from manager.models import Host, Owner, Property
from manager.serializers import HostSerializer, OwnerSerializer
...
class PropertyViewSetTestCase(BaseAPITestCase):
    ...
    def setUp(self) -> None:
        ...
        self.row_object: Property = baker.make(
            "manager.Property",
            title="Item1",
            host=self.host,
            owner=self.owner,
        ...
        self.row_object_two: Property = baker.make(
            "manager.Property",
            title="Item2",
            host=self.host,
            owner=self.owner,
        ...
        self.post_data = {
            ...
            "host_commission": 0.2,
            "owner_commission": 0.7,
            "owner": self.owner.pk,  # type: ignore
            "host": self.host.pk,  # type: ignore
        }
        self.total_rows = 2
