...
def generate_commissions(sender, instance, created, **kwargs):
    ...
    if created:
        ...
        seazone_commission_value = total_price * Decimal(
            property_instance.seazone_commission
        )
        ...
        host_commission_value = total_price * Decimal(
            property_instance.host_commission
        )
        ...
        owner_commission_percent = 1 - (
            property_instance.seazone_commission
            + property_instance.host_commission
        )
        owner_commission_value = total_price - (
            seazone_commission_value + host_commission_value
        )
